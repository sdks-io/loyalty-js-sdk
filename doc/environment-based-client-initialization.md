...
import { Client, Configuration } from 'shell-loyalty-sdk';
...
PUBLIC_BEARER_TOKEN_ACCESS_TOKEN=accesstoken
PUBLIC_BASIC_TOKEN_PUBLIC_BASIC_TOKEN=public basic token
PRIVATE_BASIC_TOKEN_PUBLIC_BASIC_TOKEN=public basic token
CLIENT_AUTHORIZATION_TOKEN_OAUTH_CLIENT_ID=oauthclientid
CLIENT_AUTHORIZATION_TOKEN_OAUTH_CLIENT_SECRET=oauthclientsecret
CLIENT_AUTHORIZATION_TOKEN_OAUTH_CLOCK_SKEW=0
CUSTOMER_HEADER_AUTHORIZATION_TOKEN=authorization-token
